...
const services = [
  ...
  },
  {
    ...
    description:
      "Oferece atendimento clínico básico ou especializado para cuidar da saúde do animal. Inclui diagnóstico de doenças, aplicação de vacinas e orientações.",
    duration: "1h",
    price: "$45",
    icon: <Syringe />,
    linkText:
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="relative">
              ...
              {services.map((item, index) => (
                ...
                >
                  <article className="bg-[#1e293b] text-white rounded-lg p-6 space-y-4 h-full flex flex-col border-8">
                    <div className="flex-14 flex items-start justify-between">
                      <div className="flex gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-400 text-3x1 select-none">
                            {item.description}
                          </p>
                        </div>
                      </div>
          ...
          <button
            ...
            shadow-lg w-10 h-10 absolute left-3 -translate-1/2 -translate-x-1/2 top-1/2 z-10"
            onClick={scrollPrev}
          >
          ...
          <button
            className="bg-white flex items-center justify-center rounded-full 
            shadow-lg w-10 h-10 absolute -right-6 -translate-1/2 -translate-x-1/2 top-1/2 z-10"
            onClick={scrollNext}
          >
